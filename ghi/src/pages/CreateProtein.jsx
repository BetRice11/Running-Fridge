...
import { useCreateProteinMutation } from '../app/fridgeSlice'


const ProteinForm = () => {
    const [createProtein, result] = useCreateProteinMutation()
    ...
    const handleFormChange = (event) => {
        ...
        setProteinForm({ ...proteinForm, [key]: value })
    }
    const handleSubmit = async (event) => {
        event.preventDefault()
        setErrorMessage('')
        createProtein(proteinForm)
    }
    useEffect(() => {
        if (result.isSuccess) {
            navigate('/')
                ...
                <div className="bg-blue-50 shadow-xl rounded-lg px-8 py-10 mb-6 border border-blue-200">
                    ...
                    >
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                value={proteinForm.expiration_date}
                                onChange={handleFormChange}
                                type="date"
                                id="expiration_date"
                                className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-blue-300 rounded-md"
